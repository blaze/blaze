...
class TestEphemeral(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(ddesc_as_py(a._data), [1, 2, 3])
    ...
    def test_create_zeros(self):
        ...
        self.assertTrue(isinstance(a, blaze.Array))
        self.assertEqual(ddesc_as_py(a._data), [0]*10)
    ...
    def test_create_ones(self):
        ...
        self.assertTrue(isinstance(a, blaze.Array))
        self.assertEqual(ddesc_as_py(a._data), [1]*10)
    ...
    def test_create_record(self):
        ...
        self.assertEqual(ddesc_as_py(a._data), [{'val': 10, 'flt': 3.5},
                        {'val': 15, 'flt': 2.25}])
        # Test field access via attributes
        aval = a.val
        self.assertEqual(ddesc_as_py(aval._data), [10, 15])
        aflt = a.flt
        self.assertEqual(ddesc_as_py(aflt._data), [3.5, 2.25])
...
class TestBLZPersistent(MayBePersistentTest, unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(ddesc_as_py(a._data), [2])
    ...
    def test_append2(self):
        ...
        append(a, lvals)
        self.assertEqual(ddesc_as_py(a._data), lvals)
