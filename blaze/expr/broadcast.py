...
Broadcastable = (Map, Field, DateTime, UnaryOp, BinOp, Coerce, Shift, Like, UnaryStringFunction)
WantToBroadcast = (Map, DateTime, UnaryOp, BinOp, Coerce, Shift, Like, UnaryStringFunction)
