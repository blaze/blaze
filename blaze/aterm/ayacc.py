...
_lr_productions = [
  ...
  ('expr -> avalue','expr',1,'p_expr1','parse.py',116),
  ('expr -> value','expr',1,'p_expr1','parse.py',117),
  ('avalue -> value { annotation }','avalue',4,'p_avalue','parse.py',123),
  ('value -> term','value',1,'p_value','parse.py',127),
  ('value -> appl','value',1,'p_value','parse.py',128),
  ('value -> list','value',1,'p_value','parse.py',129),
  ('value -> tuple','value',1,'p_value','parse.py',130),
  ('value -> string','value',1,'p_value','parse.py',131),
  ('value -> placeholder','value',1,'p_value','parse.py',132),
  ('value -> empty','value',1,'p_value','parse.py',133),
  ('term -> DOUBLE','term',1,'p_term_double','parse.py',139),
  ('term -> INT','term',1,'p_term_int','parse.py',143),
  ('term -> NAME','term',1,'p_term_term','parse.py',147),
  ('annotation -> value','annotation',1,'p_annotation1','parse.py',155),
  ('annotation -> annotation , annotation','annotation',3,'p_annotation2','parse.py',159),
  ('appl -> term ( appl_value )','appl',4,'p_appl','parse.py',165),
  ('appl_value -> expr','appl_value',1,'p_appl_value1','parse.py',169),
  ('appl_value -> appl_value , appl_value','appl_value',3,'p_appl_value2','parse.py',176),
  ('list -> [ list_value ]','list',3,'p_list','parse.py',182),
  ('list_value -> expr','list_value',1,'p_list_value1','parse.py',186),
  ('list_value -> list_value , list_value','list_value',3,'p_list_value2','parse.py',193),
  ('tuple -> ( tuple_value )','tuple',3,'p_tuple','parse.py',199),
  ('tuple_value -> expr','tuple_value',1,'p_tuple_value1','parse.py',203),
  ('tuple_value -> tuple_value , tuple_value','tuple_value',3,'p_tuple_value2','parse.py',210),
  ('string -> STRING','string',1,'p_string','parse.py',216),
  ('placeholder -> < PLACEHOLDER ( appl_value ) >','placeholder',6,'p_placeholder1','parse.py',222),
  ('placeholder -> < PLACEHOLDER >','placeholder',3,'p_placeholder2','parse.py',226),
  ('empty -> <empty>','empty',0,'p_empty','parse.py',232),
]
