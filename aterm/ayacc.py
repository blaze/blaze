...
_lr_productions = [
  ...
  ('expr -> avalue','expr',1,'p_expr1','',95),
  ('expr -> value','expr',1,'p_expr1','',96),
  ('avalue -> value { annotation }','avalue',4,'p_avalue','',102),
  ('value -> term','value',1,'p_value','',106),
  ('value -> appl','value',1,'p_value','',107),
  ('value -> list','value',1,'p_value','',108),
  ('value -> tuple','value',1,'p_value','',109),
  ('value -> string','value',1,'p_value','',110),
  ('value -> placeholder','value',1,'p_value','',111),
  ('value -> empty','value',1,'p_value','',112),
  ('term -> DOUBLE','term',1,'p_term_double','',118),
  ('term -> INT','term',1,'p_term_int','',122),
  ('term -> NAME','term',1,'p_term_term','',126),
  ('annotation -> value','annotation',1,'p_annotation1','',134),
  ('annotation -> annotation , annotation','annotation',3,'p_annotation2','',138),
  ('appl -> term ( appl_value )','appl',4,'p_appl','',144),
  ('appl_value -> expr','appl_value',1,'p_appl_value1','',148),
  ('appl_value -> appl_value , appl_value','appl_value',3,'p_appl_value2','',155),
  ('list -> [ list_value ]','list',3,'p_list','',161),
  ('list_value -> expr','list_value',1,'p_list_value1','',165),
  ('list_value -> list_value , list_value','list_value',3,'p_list_value2','',172),
  ('tuple -> ( tuple_value )','tuple',3,'p_tuple','',178),
  ('tuple_value -> expr','tuple_value',1,'p_tuple_value1','',182),
  ('tuple_value -> tuple_value , tuple_value','tuple_value',3,'p_tuple_value2','',189),
  ('string -> STRING','string',1,'p_string','',195),
  ('placeholder -> < PLACEHOLDER ( appl_value ) >','placeholder',6,'p_placeholder1','',201),
  ('placeholder -> < PLACEHOLDER >','placeholder',3,'p_placeholder2','',205),
  ('empty -> <empty>','empty',0,'p_empty','',211),
]
