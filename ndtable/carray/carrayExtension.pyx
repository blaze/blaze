...
cdef public class chunk [type chunktype, object chunk]:
    ...
    cpdef _getitem(self, int start, int stop, char *dest):
    ...
    def __repr__(self):
        ...
        # XXX: this didn't seem to work in vanilla carary ~Steve
        fullrepr = "chunk()    nbytes: %d; cbytes: %d; ratio: %.2f\n%r" % \
                (self.nbytes, self.cbytes, cratio, str(self))
        return fullrepr
